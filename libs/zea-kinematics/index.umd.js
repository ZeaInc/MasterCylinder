(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@zeainc/zea-engine'), require('@zeainc/zea-ux')) :
  typeof define === 'function' && define.amd ? define(['exports', '@zeainc/zea-engine', '@zeainc/zea-ux'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.zeaKinematics = {}, global.zeaEngine, global.zeaUx));
}(this, (function (exports, zeaEngine, zeaUx) { 'use strict';
  ...
  class ExplodePartParameter extends zeaEngine.StructParameter {
    ...
    constructor(name) {
      ...
      this.__stageParam = this.addMember(new zeaEngine.NumberParameter('Stage', 0));
      this.__axisParam = this.addMember(new zeaEngine.Vec3Parameter('Axis', new zeaEngine.Vec3(1, 0, 0)));
      ...
      this.__multiplierParam = this.addMember(new zeaEngine.NumberParameter('Multiplier', 1.0));
    }
  ...
  class GearParameter extends zeaEngine.StructParameter {
    ...
    constructor(name) {
      ...
      this.__ratioParam = this.addMember(new zeaEngine.NumberParameter('Ratio', 1.0));
      this.__offsetParam = this.addMember(new zeaEngine.NumberParameter('Offset', 0.0));
      this.__axisParam = this.addMember(new zeaEngine.Vec3Parameter('Axis', new zeaEngine.Vec3(1, 0, 0)));
    }
  ...
  class IKSolver extends zeaEngine.Operator {
    ...
    constructor(name) {
      ...
      this.addParameter(new zeaEngine.NumberParameter('Iterations', 5));
    ...
    addJoint(globalXfoParam, axisId = 0, limits = [-180, 180]) {
      ...
      const output = this.addOutput(new zeaEngine.OperatorOutput('Joint' + this.joints.length));
  ...
  class XfoTrackDisplay extends zeaEngine.GeomItem {
    ...
    constructor(track) {
      ...
      const linesMat = new zeaEngine.Material('trackLine', 'LinesShader');
  ...
  if (zeaEngine.libsRegistry) {
    zeaEngine.libsRegistry.registerLib(pkg);
  } else {
    console.warn(
